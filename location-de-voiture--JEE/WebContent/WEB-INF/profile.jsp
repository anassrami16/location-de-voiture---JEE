					...
					<div
						...
						<div class="row user-detail">
							<div class="col-lg-12 col-sm-12 col-12">
								...
								<h5></h5>
								<p>
									<i class="fa fa-map-marker" aria-hidden="true"></i> <%=user.getNom()+" "+user.getPrenom() %>
								</p>
								...
								<hr>
								<div>
									<span><i class="fa fa-user mr-1"></i>FirstName:<%=user.getPrenom() %> </span>
								</div>
								<div>
								...
								<div>
									<span><i class="fas fa-phone-square-alt mr-2"></i>Tel: <%=user.getTelephone()%></span>
								</div>

								<div>
									<span><i class="fa fa-envelope-square mr-2"></i>Email: <%=user.getEmail()%></span>
								</div>
								<div>
									<span><i class="fa fa-user mr-1"></i>Num_permis: <%=user.getNum_permis()%></span>
								</div>
								<div>
									<span><i class="fa fa-user mr-1"></i>CiN: <%=user.getCin()%></span>
								</div>
								<div>
