...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/style1.css">
...
<body style="background-image: url('${pageContext.request.contextPath}/res/img/5.jpg');" >


	<%@ include file="navbar.jsp"%>
<form action="voiture1?action=ajoutervoiture" enctype="multipart/form-data" method="post">
    <div class="root_container">
        ...
        <div class="wraper">
            ...
            <div class="data_wrapper">
                ...
                <div class="entery_wraper">
                    <label>Marque</label>
                    <input type="text" placeholder="Marque" value="" name="marque" required="required">
                </div>
                
                                <div class="entery_wraper">
                    <label>Modéle</label>
                    <input type="text" placeholder="Modéle" value="" name="modéle" required="required">
                </div>
        ...
        <div class="wraper">
            ...
            <div class="data_wrapper">
                ...
                <div class="entery_wraper">
                    ...
                    <select name="carburant" required="required">
                ...
                <!-- one entery wraper-->
                <div class="entery_wraper">
                    <label>Boit a vitesse</label>
                    <select name="boitvts" required="required">
                ...
                <div class="entery_wraper">
                    ...
                    <input type="number" name="places" placeholder="places"  id="places" max="10" min="0" required="required">
                </div>
                <!-- one entery wraper-->
                <div class="entery_wraper">
                    <label>Nombre de ports</label>
                    <input type="number" name="ports" placeholder="ports"  id="ports" max="8" min="0" required="required">
                </div>
                <!-- one entery wraper-->
                <div class="entery_wraper">
                    <label>Kilométrage</label>
                    <select name="kilometrage" required="required">
        ...
        <div class="wraper">
            ...
            <div class="data_wrapper">
                ...
                <div class="entery_wraper">
                    <label>ville</label>
                    <input type="text" value="" name="ville" placeholder="ville"  id="ville" required="required">
                </div>
                <!-- one entery wraper-->
                <div class="entery_wraper">
                    <label>prix/jour</label>
                    <input type="number" name="prix" id="prix" placeholder="prix" min="0" required="required">
                </div>

                <!-- one entery wraper-->
                <div class="entery_wraper">
                    <label>Lieu de rencontre</label>
                    <input type="text" name="lieu" id="lieu" placeholder="lieu"  required="required">
                </div>
        ...
        <div class="wraper">
            ...
            <div class="data_wrapper">
                ...
                <div class="entery_wraper extend_wraper">
                    ...
                    <textarea name="description" id="" cols="30" rows="10" placeholder="description"  style="width: 80%;" required="required"></textarea>
                </div>
        ...
        <div class="wraper">
            ...
            <div class="data_wrapper">
                ...
                <div class="entery_wraper extend_wraper">
                        ...
                        <button class="call_to_action" style="margin:106px"> Poster</button>
