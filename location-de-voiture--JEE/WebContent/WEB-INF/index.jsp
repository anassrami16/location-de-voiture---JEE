                            ...
                            <div class="col-xs-12 col-sm-5">
                                <div class="tcb-product-item pl-3">
                                    <div class="tcb-product-photo">
                                        ...
                                        <button type="submit" style="border:none;">
                                        <img src="${pageContext.request.contextPath}/res/voiture/<%=list.get(5).getPHOTO1() %>" class="img-responsive  h-100 w-100"  alt="a" />
                                        </button>
                                    ...
                                    <div class="tcb-product-info">
                                        <div class="tcb-product-title">
                                            ...
                                            <h4><button type="submit" style="border:none;"> <%=list.get(5).getMarque() %>, <%=list.get(5).getModele() %> </button></h4>
                                        
                                        </div>
                                        <p><%=list.get(5).getLieu_rencontre()%>, <%=list.get(5).getVille()%></p>
                                        <div class="tcb-hline"></div>
                                        <div class="tcb-product-price" style="font-weight:bold">
                                            <%=list.get(5).getPrix()%> Dirhams/jours
                                        </div>
