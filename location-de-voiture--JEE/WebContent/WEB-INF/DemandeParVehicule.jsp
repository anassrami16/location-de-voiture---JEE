				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12">
						<div class="container text-center" style="margin: 0 auto;">
							...
							<div class="row">
								<h1 style="margin: 0 auto;">aucun demande trouver</h1>
							</div>
