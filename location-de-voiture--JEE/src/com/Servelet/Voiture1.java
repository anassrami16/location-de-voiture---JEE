...
//				System.out.println(""+f);
			...
			try {
				multiparts.get(13).write(new File("C:\\Users\\dododo\\git\\location-de-voiture\\location-de-voiture--JEE\\WebContent\\res\\voiture" + File.separator + i+"1"+".jpg"));
				multiparts.get(14).write(new File("C:\\Users\\dododo\\git\\location-de-voiture\\location-de-voiture--JEE\\WebContent\\res\\voiture" + File.separator + i+"2"+".jpg"));
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			Voiture voiture=new Voiture(0, marque, modéle, carburant, Integer.parseInt(kilometrage), IMMATRICULATION,
					TYPE_VRHICULE, photo1, photo2, boite_vitesse,Integer.parseInt(places) ,Integer.parseInt(ports),
					user.getId_user(), DATEFIN, DATEDEB,Integer.parseInt(prix) , description, lieu, ville);
			try {
